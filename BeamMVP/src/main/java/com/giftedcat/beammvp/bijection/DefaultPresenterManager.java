...
public class DefaultPresenterManager extends PresenterManager {
    ...
    private HashMap<String, BeamBasePresenter> idToPresenter = new HashMap<>();
    private int nextId;

    @Override
    public <T extends BeamBasePresenter> T create(Object view) {
    ...
    @Override
    public <T extends BeamBasePresenter> T get(String id) {
